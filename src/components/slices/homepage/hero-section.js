      ...
      >
        <MDBContainer>
          <MDBRow className="my-md-5 py-md-5">
            <MDBCol size="12" md="7" className="my-5 py-5 pr-5">
              ...
              <MDBRow className="mt-md-5">
                <MDBCol>
                  ...
                  >
                    <MDBBtn color="primary" tag="span" className="btn-rounded">
            ...
            <MDBCol size="12" md="5">
              <MDBIcon icon="tachometer-alt" size="10x" />
              <p>
                This is where the screen will go. The hero nbackground will be a
                gradient
              </p>
            </MDBCol>
          </MDBRow>
